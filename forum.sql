...
-- Listage de la structure de la table topic_dwwm. category
CREATE TABLE IF NOT EXISTS `category` (
  `id_category` int(11) NOT NULL AUTO_INCREMENT,
  `nameCategory` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id_category`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=latin1;

-- Listage des données de la table topic_dwwm.category : ~0 rows (environ)
...
-- Listage des données de la table topic_dwwm.message : ~6 rows (environ)
...
CREATE TABLE IF NOT EXISTS `topic` (
  ...
  KEY `topic_category` (`category_id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1;

-- Listage des données de la table topic_dwwm.topic : ~4 rows (environ)
/*!40000 ALTER TABLE `topic` DISABLE KEYS */;
INSERT INTO `topic` (`id_topic`, `title`, `dateTopic`, `lock`, `user_id`, `category_id`) VALUES
	(1, 'topic1', '2022-06-17 11:37:35', NULL, 2, 1),
	(2, 'topic2', '2022-06-17 11:37:54', NULL, 3, 3),
	(3, 'topic3', '2022-06-17 11:38:18', NULL, 1, 1),
	(4, 'topic4', '2022-06-17 11:38:43', NULL, 2, 2);
...
-- Listage des données de la table topic_dwwm.user : ~2 rows (environ)
